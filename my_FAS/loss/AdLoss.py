...
def Real_AdLoss_double(discriminator_out, criterion, shape_list):
    # generate ad_label
    ad_label1_index = torch.LongTensor(shape_list[0], 1).fill_(0)
    ad_label1 = ad_label1_index.cuda()
    ad_label2_index = torch.LongTensor(shape_list[1], 1).fill_(1)
...
def Real_AdLoss_single(discriminator_out, criterion, shape_list):
    # generate ad_label
    ad_label1_index = torch.LongTensor(shape_list[0], 1).fill_(0)
    ad_label1 = ad_label1_index.cuda()
    ad_label = ad_label1.view(-1)
...
def Fake_AdLoss_double(discriminator_out, criterion, shape_list):
    # generate ad_label
    ad_label1_index = torch.LongTensor(shape_list[0], 1).fill_(0)
    ad_label1 = ad_label1_index.cuda()
    ad_label2_index = torch.LongTensor(shape_list[1], 1).fill_(1)
...
def Fake_AdLoss_single(discriminator_out, criterion, shape_list):
    # generate ad_label
    ad_label1_index = torch.LongTensor(shape_list[0], 1).fill_(0)
    ad_label1 = ad_label1_index.cuda()
    ad_label = ad_label1.view(-1)
...
def AdLoss_Limited_double(discriminator_out, criterion, shape_list):
    # generate ad_label
    ad_label2_index = torch.LongTensor(shape_list[0], 1).fill_(0)
    ad_label2 = ad_label2_index.cuda()
    ad_label = torch.cat([ad_label2], dim=0).view(-1)
