...
def main():
    ...
    parser.add_argument("--input", default='', help="path to the input image")
    parser.add_argument("--output", default='./test_0416.tif', help="path to the output image")
    ...
    npmat = np.random.randint(0,256,(32,32,3))
    npmat = np.array(npmat, dtype=np.uint8)
